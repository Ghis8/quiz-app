...
const Layout = ({children}) => {
  ...
  return (
    <div className='h-screen'>
        ...
        <div className='h-5/6 my-2 overflow-y-auto'>
                  ...
                  <div className='w-3/4 mx-auto px-2 mt-5 flex flex-col space-y-2'>
                    <div className='flex justify-between'>
                        ...
                        <div className='flex  space-x-1'> 
                          ...
                          <span className='text-blue-500'><TimeCountDown duration={choosedQuiz.time} /></span>
                        </div>
                    ...
                    
                    {
                      showScore && questionIndex ===choosedQuiz.question_number ?(
                        <div className='flex flex-col space-y-4'>
                          ...
                          <button onClick={()=>window.location.reload(true)} className='py-1 px-2 text-white hover:bg-blue-300  bg-blue-500 w-1/6 rounded-md'>Take a Quiz</button>
                        </div>
                      ):
                  ...
                  <div className='flex flex-col space-y-2'>
                    {
                      ...
                      <div className='flex items-center mt-44 justify-center'>
                        <span className='text-gray-700 text-2xl'>No Quiz Found! Create a Quiz</span>
                      </div>
                    }
                    {
                      quizzes?.map((quiz,i)=>(
                        <div onClick={()=>{
                          ...
                          <div className='flex flex-col space-y-1'>
                            <div className='flex items-center space-x-5'>
                              ...
                              <span className='text-orange-400'>Time : {quiz.time/60} minutes</span>
                            </div>
